...
export default function Haryana() {
                ...
                <div className="flex flex-col lg:flex-row gap-6 mt-2">
                    <div className="w-full lg:w-[70%] flex flex-col gap-4">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <Link to={mainNews._id ? `/news/${mainNews.slug || mainNews._id}` : '#'} className="col-span-1 md:col-span-2 relative group cursor-pointer overflow-hidden shadow-sm bg-black border border-gray-200 flex flex-col w-full md:aspect-[16/9] h-[250px] md:h-auto">
                            ...
                            <Link to={topSideNews._id ? `/news/${topSideNews.slug || topSideNews._id}` : '#'} className="col-span-1 bg-[#f0f2f5] shadow-sm flex flex-col group cursor-pointer border border-gray-200 block">
