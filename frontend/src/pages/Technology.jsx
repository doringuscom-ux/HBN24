...
export default function Technology() {
    ...
    useEffect(() => {
        const fetchNews = async () => {
            try {
                ...
                const techRes = await fetch('http://localhost:5000/api/news/technology');
                let techData = [];
                if (techRes.ok) {
    ...
    return (
        <div className="w-full min-h-screen bg-[#f3f4f6]">
            {/* Banner Section */}
            <div className="w-full h-[160px] relative overflow-hidden flex items-center px-10" style={{ background: 'linear-gradient(to right, #4338ca, #6366f1, #818cf8)' }}>
                
                {/* Background Watermark Right */}
                <div className="absolute right-0 top-1/2 transform -translate-y-1/2 pointer-events-none opacity-20 text-white">
                    <FaRobot className="w-[200px] h-[200px]" />
                </div>

                {/* Left side Graphics */}
                <div className="absolute left-[20px] top-1/2 transform -translate-y-1/2 pointer-events-none opacity-20 text-white">
                ...
                <div className="w-[1270px] mx-auto flex items-center justify-between relative z-10 pl-[120px]">
                    ...
                    <div className="flex flex-col justify-center">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <h1 className="text-white text-[46px] font-black tracking-wide drop-shadow-md" style={{ fontFamily: '"Mukta", sans-serif' }}>टेक्नोलॉजी</h1>
                        </div>
                    </div>
