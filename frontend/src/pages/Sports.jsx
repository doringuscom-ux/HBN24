...
export default function Sports() {
    ...
    useEffect(() => {
        const fetchNews = async () => {
            try {
                ...
                const sportsRes = await fetch(__API_URL__ + '/api/news/sports');
                let sportsData = [];
                if (sportsRes.ok) {
    ...
    return (
        <div className="w-full min-h-screen bg-[#f3f4f6]">
            {/* Banner Section */}
            <div className="w-full h-[160px] relative overflow-hidden flex items-center px-10" style={{ background: 'linear-gradient(to right, #047857, #10b981, #34d399)' }}>
                
                {/* Background Watermark Right */}
                <div className="absolute right-[-20px] top-1/2 transform -translate-y-1/2 opacity-20 pointer-events-none text-white">
                    <MdSportsCricket className="w-[300px] h-[300px]" />
                </div>

                {/* Left side Graphics */}
                <div className="absolute left-[-50px] top-1/2 transform -translate-y-1/2 opacity-20 pointer-events-none text-white">
                ...
                <div className="w-[1270px] mx-auto flex items-center justify-between relative z-10 pl-[120px]">
                    ...
                    <div className="flex flex-col justify-center">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <h1 className="text-white text-[46px] font-black tracking-wide drop-shadow-md" style={{ fontFamily: '"Mukta", sans-serif' }}>खेल जगत</h1>
                        </div>
                    </div>
