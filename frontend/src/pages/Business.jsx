...
export default function Business() {
    ...
    useEffect(() => {
        const fetchNews = async () => {
            try {
                ...
                const businessRes = await fetch('http://localhost:5000/api/news/business');
                let businessData = [];
                if (businessRes.ok) {
    ...
    return (
        <div className="w-full min-h-screen bg-[#f3f4f6]">
            {/* Banner Section */}
            <div className="w-full h-[160px] relative overflow-hidden flex items-center px-10" style={{ background: 'linear-gradient(to right, #1e3a8a, #2563eb, #60a5fa)' }}>
                ...
                <div className="w-[1270px] mx-auto flex items-center justify-between relative z-10 pl-[120px]">
                    ...
                    <div className="flex flex-col justify-center">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <h1 className="text-white text-[46px] font-black tracking-wide drop-shadow-md" style={{ fontFamily: '"Mukta", sans-serif' }}>बिजनेस</h1>
                        </div>
                    </div>
