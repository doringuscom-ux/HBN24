                    ...
                    <div className="flex flex-col justify-center w-full md:w-auto">
                        ...
                        <div className="flex items-center justify-between w-full md:w-auto">
                            <div className="flex items-center gap-3">
                                {/* Mobile Icon */}
                                <img src={dhrmIconImg} alt="Dharma" className="w-12 h-12 object-contain drop-shadow-md md:hidden" />
                                {/* Desktop Icon */}
                ...
                <div className="flex flex-col lg:flex-row gap-6 mt-2">
                    ...
                    <div className="w-full lg:w-[70%] flex flex-col gap-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <Link to={`/news/${mainNews.slug || mainNews._id}`} className="col-span-1 md:col-span-2 relative group cursor-pointer overflow-hidden shadow-sm bg-black border border-gray-200 flex flex-col w-full md:aspect-[16/9] h-[250px] md:h-auto">
                                {mainNews.image ? (
