...
export default function Religion() {
    ...
    useEffect(() => {
        const fetchNews = async () => {
            try {
                ...
                const religionRes = await fetch('http://localhost:5000/api/news/religion');
                let religionData = [];
                if (religionRes.ok) {
    ...
    return (
        <div className="w-full min-h-screen bg-[#f3f4f6]">
            {/* Banner Section */}
            <div className="w-full h-[160px] relative overflow-hidden flex items-center px-10" style={{ background: 'linear-gradient(to right, #8d570f, #b97a0c, #f3bd18)' }}>
                
                {/* Background Watermark Right */}
                <div className="absolute right-0 top-1/2 transform -translate-y-1/2 pointer-events-none">
                    <img src={rhCircleImg} alt="Right Circle" className="h-[180px] w-auto object-contain" />
                </div>

                {/* Left side Graphics */}
                <div className="absolute left-[-20px] top-1/2 transform -translate-y-1/2 pointer-events-none">
                    <img src={lfCircleImg} alt="Left Circle" className="h-[180px] w-auto object-contain" />
                </div>
                    ...
                    <div className="flex flex-col justify-center">
                        ...
                        <div className="flex items-center gap-3">
                            <div className="bg-transparent flex items-center justify-center">
                                <img src={dhrmIconImg} alt="Dharma" className="w-[50px] h-auto object-contain" />
                            </div>
                            <h1 className="text-white text-[46px] font-black tracking-wide drop-shadow-md" style={{ fontFamily: '"Mukta", sans-serif' }}>धर्म कर्म</h1>
                        </div>
                    </div>
